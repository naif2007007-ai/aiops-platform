...
def build_features():
    ...
    base = assets[["asset_id","lifecycle_age_yrs","days_since_maintenance",
                   "maintenance_count","criticality","will_fail"]].copy()
    ...
    feat = base.merge(af,on="asset_id",how="left").merge(tf,on="asset_id",how="left").merge(lf,on="asset_id",how="left")
    feat["alarm_to_ticket_ratio"] = (feat["ticket_count"] / feat["alarm_count_total"].replace(0,np.nan)).fillna(0).round(4)
