...
# Safe merge with only existing columns
available = [c for c in ["asset_id","alarm_count_30d","ticket_p1_count",
             "log_anomaly_days","avg_cpu","days_since_maintenance"]
             if c in feat.columns]
df = preds.merge(feat[available], on="asset_id", how="left")
...
base_cols    = ["asset_id","criticality","lifecycle_age_yrs",
                "failure_probability","risk_level","recommended_action"]
extra_cols   = [c for c in ["days_since_maintenance","alarm_count_30d","avg_cpu"]
...
col_names = {
    ...
    "lifecycle_age_yrs":     "Age (yrs)",
    "failure_probability":   "Failure Risk",
    "risk_level":            "Status",
    "recommended_action":    "What To Do",
    "days_since_maintenance":"Days Since Service",
    "alarm_count_30d":       "Alerts (30 days)",
    "avg_cpu":               "Avg CPU %",
}
disp = disp.rename(columns=col_names)
